...
cloudsigma@micado-master:~/component-jqueuer-agent$
cloudsigma@micado-master:~/component-jqueuer-agent$
cloudsigma@micado-master:~/component-jqueuer-agent$
cloudsigma@micado-master:~/component-jqueuer-agent$ vim /etc/
Display all 195 possibilities? (y or n)
cloudsigma@micado-master:~/component-jqueuer-agent$ cat parameters.py
import redis
import os
